...
class Giohang extends CI_Controller {
    ...
    public function index(){
        $this->data['title']='DecorViet - Giỏ hàng của bạn';
    ...
    public function info_order(){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $this->data['title']='DecorViet - Thông tin đơn hàng';
    ...
    public function thankyou(){
        if($this->session->userdata('info-customer')||$this->session->userdata('sessionKhachHang')){
            ...
            $this->email->to($list);
            $this->email->subject('Hệ thống DecorViet');
        ...
        $this->data['title']='contact.decorviet.vn - Kết quả đơn hàng';
