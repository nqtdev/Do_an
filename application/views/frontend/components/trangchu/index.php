    ...
    <div class="slider">
        <div class="container">
           <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 list-menu pull-left" style="height: 321px;">
             <img style="width: 100%; height: 160px;" src="public/images/aa.png">
             <img style="width: 100%; height: 160px;" src="public/images/bb.png">
         </div>
...
<div class="container" style="margin-top: 20px;">
    <div class="sale-title" style="background-color: #934D28;">
        <span>SẢN PHẨM BÁN CHẠY NHẤT HÔM NAY</span>
    </div>
</div>
<div class="container" style="margin-bottom: 20px;">
    <div class="owl-carousel owl-carousel-product owl-theme" style="border: 1px solid #934D28;">
        <?php 
